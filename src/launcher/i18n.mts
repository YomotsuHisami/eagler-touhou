...
const entries = [
  ...
  ["gameNotice.credit", "@SteinsGateON 大大", "@SteinsGateON"],
  ["gameNotice.creditAfter", " 的逆向。", " for the reverse engineering."],
  ["gameNotice.repoBefore", "该游戏的 ", "This game's "],
  ["gameNotice.repo", "Github 仓库", "GitHub repository"],
